...
import "./NonMovingItemReport.css";
...
export default function MovingItemReport() {
  ...
  return (
    <div className="non-moving-report-container">
      {/* NAVBAR */}
      <div className="navbar">
        ...
        <div className="non-moving-title">Non Moving Item Report</div>
        <div className="nav-title">Company Name</div>
      </div>

      {/* DROPDOWN */}
      {menuOpen && (
        <div ref={dropdownRef} className="nmir-dropdown">
          {menuItems.map((item, index) => (
            <a
              key={index}
              href={item.href}
              className="nmir-nav-link"
              onClick={() => setMenuOpen(false)}
            >
              <span className="nmir-nav-link-icon">{item.icon}</span>
              <span className="nmir-nav-link-text">{item.label}</span>
            </a>
          ))}
        </div>
      )}
